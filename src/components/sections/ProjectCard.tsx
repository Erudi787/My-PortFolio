...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-white/60 to-white/10 pointer-events-none z-0"></div>
      {project.imageUrl && (
      ...
      <div className="p-7 flex flex-col flex-grow relative z-10">
        ...
        >
          ...
          <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#00C6C6] transition-all duration-300 group-hover/link:w-full"></span>
        </Link>
      </div>
    </motion.div>
  );
