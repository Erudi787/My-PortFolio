...
export default async function ProjectDetailPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return (
    <section className="py-24 md:py-32 bg-gradient-to-b from-[#F0F4F8] to-white dark:from-[#0B1120] dark:to-[#030712] transition-colors duration-300 min-h-screen relative overflow-hidden">
      {/* Immersive Background Effects */}
      <div className="absolute top-20 right-10 w-[600px] h-[600px] bg-[#00C6C6]/5 rounded-full blur-[120px] -z-10 pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-[500px] h-[500px] bg-[#0A4DDE]/5 rounded-full blur-[100px] -z-10 pointer-events-none" />

      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-10 relative z-10">
          <Link href="/projects" className="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-[#00C6C6] dark:hover:text-[#00C6C6] font-medium transition-colors group relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-[-2px] after:left-0 after:bg-[#00C6C6] after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left">
